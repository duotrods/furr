...
// Fetch all services to get available sizes
$allServices = getAllServices(); // You'll need to create this function in your config
$availableSizes = [];
                                        ...
                                        <select id="pet_size" name="pet_size" required
                                            ...
                                            <?php foreach ($availableSizes as $size): ?>
                                                    <option value="<?php echo htmlspecialchars($size); ?>" 
                                                        <?php echo $size === $service['size'] ? 'selected' : ''; ?>>
