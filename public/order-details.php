        ...
        <?php if (isset($_SESSION['success_message'])): ?>
            <div class="mb-8 p-4 bg-emerald-50 border-l-4 border-emerald-500 rounded-lg shadow-sm">
                <div class="flex items-center">
                    ...
                    <p class="text-emerald-700 font-medium"><?php echo $_SESSION['success_message']; unset($_SESSION['success_message']); ?></p>
                </div>
            </div>
        <?php endif; ?>
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <span class="text-2xl font-mono text-slate-600">#<?php echo str_pad($order_id, 5, '0', STR_PAD_LEFT); ?></span>
                        <?php 
                        ...
                        ?>
                        <span class="px-4 py-2 rounded-full text-sm font-semibold border <?php echo implode(' ', $statusClass); ?>">
                ...
                <div class="text-right">
                    ...
                    <p class="text-lg font-semibold text-slate-700"><?php echo date('M j, Y', strtotime($order['order_date'])); ?></p>
                    ...
                    <div class="p-8">
                        <div class="space-y-6">
                            <?php foreach ($order_items as $index => $item): ?>
                                <div class="flex items-center space-x-6 p-6 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors duration-200">
                                    ...
                                    <div class="flex-grow">
                                        <h3 class="text-lg font-semibold text-slate-800 mb-2"><?php echo $item['name']; ?></h3>
                                        <div class="flex items-center space-x-4 text-sm text-slate-600">
                                            <span class="bg-white px-3 py-1 rounded-full border">Qty: <?php echo $item['quantity']; ?></span>
                                            <span class="bg-white px-3 py-1 rounded-full border">₱<?php echo number_format($item['price'], 2); ?> each</span>
                                        </div>
                                    </div>
                                    
                                    <div class="text-right">
                                        <p class="text-2xl font-bold text-slate-800">₱<?php echo number_format($item['price'] * $item['quantity'], 2); ?></p>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        </div>
                        ...
                        <div class="mt-8 pt-6 border-t-2 border-slate-200">
                            <div class="flex justify-between items-center p-6 bg-slate-800 text-white rounded-xl">
                                ...
                                <span class="text-3xl font-bold">₱<?php echo number_format($order['total_amount'], 2); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="pt-4 border-t border-slate-200">
                            <a href="<?php echo BASE_URL . '/' . $order['payment_proof']; ?>" 
                               target="_blank" 
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <p class="text-slate-800 font-semibold mt-1"><?php echo $order['first_name'] . ' ' . $order['last_name']; ?></p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2 p-4 bg-slate-50 rounded-lg border">
                                <p class="text-slate-800 leading-relaxed"><?php echo nl2br($order['shipping_address']); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
