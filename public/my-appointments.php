...
$stmt = $pdo->prepare("
    SELECT a.id, a.pet_name, a.pet_type, a.appointment_date, a.appointment_time, a.status, s.name AS service_name
    FROM appointments a
            ...
            <div class="text-center py-16">
                <div class="bg-white rounded-2xl shadow-sm border p-12 max-w-md mx-auto">
                    <svg class="mx-auto h-16 w-16 text-gray-300 mb-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-4 8h.01M17 8h2a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V10a2 2 0 012-2h2" />
                    </svg>
                    ...
                    <a href="#" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                        ...
                                        <div class="flex items-start space-x-4">
                                            ...
                                            <div class="min-w-0 flex-1">
                                                ...
                                                <p class="text-sm text-gray-600 mt-1">
                                                    ...
                                                    <span class="capitalize"><?= htmlspecialchars($appointment['pet_type']) ?></span>
                                                </p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        <?php if ($appointment['status'] === 'pending' || $appointment['status'] === 'confirmed'): ?>
                                            <div class="flex items-center space-x-3">
                                                <!-- Cancel Form -->
                                                <form action="../php/appointments/cancel-appointment.php" method="POST" onsubmit="return confirm('Are you sure you want to cancel this appointment?');" class="inline">
                                                    <input type="hidden" name="appointment_id" value="<?= $appointment['id'] ?>">
                                                    <button type="submit" class="inline-flex items-center px-3 py-2 border border-red-300 text-sm font-medium rounded-lg text-red-700 bg-white hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-colors duration-200">
