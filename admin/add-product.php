        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <form action="../php/admin/add-product-process.php" method="POST" enctype="multipart/form-data"
                        class="space-y-6">
                        ...
                        <div class="pt-6 border-t border-slate-200">
                            <button type="submit"
                                class="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-4 px-6 rounded-lg transition-all duration-200 transform hover:scale-[1.02] shadow-lg hover:shadow-xl flex items-center justify-center">
