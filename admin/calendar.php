    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="mb-10">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center space-x-2 bg-white px-4 py-2 rounded-xl shadow-sm border border-slate-200">
                    <div class="w-3 h-3 bg-green-400 rounded-full"></div>
                    <span class="text-sm text-slate-600 font-medium">Live Calendar</span>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-4 gap-8">
            ...
            <div class="xl:col-span-1">
                <div class="bg-white rounded-2xl shadow-lg border border-slate-200 sticky top-8">
                    <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 px-6 py-6 rounded-t-2xl">
