...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <!-- Form Content -->
            <div class="px-8 py-8">
                <form action="edit-product.php?id=<?php echo $product['id']; ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div class="group">
                        ...
                        <div class="mb-6">
                            <div class="inline-flex items-center space-x-4 p-4 bg-gray-50 rounded-xl border-2 border-gray-100">
                                <div class="flex-shrink-0">
