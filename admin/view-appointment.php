                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="hidden md:flex items-center space-x-2 text-gray-500">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3a1 1 0 012-2h4a1 1 0 012 2v4h3a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V9a2 2 0 012-2h3z"></path>
                        </svg>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 font-semibold"><?php echo htmlspecialchars($appointment['first_name'] . ' ' . $appointment['last_name']); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 font-semibold"><?php echo htmlspecialchars($appointment['email']); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg md:col-span-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 font-semibold"><?php echo htmlspecialchars($appointment['phone']); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 font-semibold"><?php echo htmlspecialchars($appointment['pet_name']); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-900 font-semibold"><?php echo htmlspecialchars($appointment['pet_type']); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="bg-gray-50 rounded-lg p-4 min-h-[100px]">
                            <?php if (!empty($appointment['notes'])): ?>
                                <p class="text-gray-800 leading-relaxed whitespace-pre-line"><?php echo nl2br(htmlspecialchars($appointment['notes'])); ?></p>
                            <?php else: ?>
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div class="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
                                ...
                                <p class="text-emerald-900 font-semibold text-lg"><?php echo htmlspecialchars($appointment['service_name']); ?></p>
                            </div>
                            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                <p class="text-sm text-green-600 font-medium mb-1">Service Price</p>
                                <p class="text-green-900 font-bold text-2xl">₱<?php echo number_format($appointment['service_price'], 2); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3 p-3 bg-violet-50 rounded-lg border border-violet-200">
                                ...
                                <div>
                                    ...
                                    <p class="text-violet-900 font-semibold"><?php echo formatDate($appointment['appointment_date']); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3 p-3 bg-indigo-50 rounded-lg border border-indigo-200">
                                ...
                                <div>
                                    ...
                                    <p class="text-indigo-900 font-semibold"><?php echo formatTime($appointment['appointment_time']); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
