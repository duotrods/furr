...
//appointments order in appointment.php admin
function getAllAppointments2($status = null)
{
    global $pdo;
...
function archivedAppointments($status = null)
{
    global $pdo;

    $sql = "SELECT a.*, u.first_name, u.last_name, s.name AS service_name, s.price AS service_price 
            FROM appointments a
